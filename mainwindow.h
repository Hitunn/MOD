...
signals:
    ...
    void sigCloseSerial();
    void sigReadRequest(int slaveaddr,int startaddr,int numregs,bool isheartbeat,bool allowRetry);
...
private:
    ...
    QLabel*heartStatusLabel;
    QLabel*statusLable;
    QLineEdit*writeSlaveId;
    QLineEdit*writeAddr;
    QLineEdit*writeValue;
    QLineEdit*readSlaveId;
    QLineEdit*readRegaddr;
    QLineEdit*readNumregs;
